      ...
      if (FD_ISSET(i, &sel_fds))
      {
        ...
        else 
        {
          ...
          if (!strncmp(buffer, "NICK ", 5)) // command NICK <nickname>
          {
            ...
            {
              strcpy(msg_aux, "RPLY 002 - Erro. Falta introdução do nome.");
            ...
            {
              strcpy(msg_aux, "RPLY 003 - Erro. Nome pedido não válido.");
            ...
            {
              strcpy(msg_aux, "RPLY 004 - Erro. Nome já em uso.");
            ...
            else
            {
              ...
              strcpy(msg_aux, "RPLY 0001 - Nome atribuído com sucesso.");
          ...
          else if (!strncmp(buffer, "MSSG ", 5)) // command MSSG <message>
          {
            ...
            {
              strcpy(msg_aux, "RPLY 102 - Erro. Não há texto na mensagem.");
          ...
          else if (!strncmp(buffer, "PASS ", 5)) // command PASS <password>
          {
            memmove(buffer, buffer + 5, BUFSIZE); // removes the command prefix
						...
						{
              strcpy(msg_aux, "RPLY 202 - Erro. Nome não está definido.");
              ...
              strcpy(msg_aux, "RPLY 201 - Autenticação com sucesso.");
          ...
          else if (!strncmp(buffer, "JOIN ", 5)) // command JOIN <room no>
          {
            ...
            {
              strcpy(msg_aux, "RPLY 303 - Erro. Não pode mudar para o canal.");
            ...
            else if (!strncmp(buffer, "0", 1)) // input was 0
            {
              ...
              strcpy(msg_aux, "RPLY 301 - Mudança de canal com sucesso.");
            ...
            else if (!strncmp(buffer, "1", 1)) // input was 1
            {
              ...
              strcpy(msg_aux, "RPLY 301 - Mudança de canal com sucesso. (CH 1)");
            ...
            else if (!strncmp(buffer, "2", 1)) // input was 2
            {
              ...
              strcpy(msg_aux, "RPLY 301 - Mudança de canal com sucesso. (CH 2)");
            ...
            {
              strcpy(msg_aux, "RPLY 302 - Erro. Canal não existe.");
          ...
          else if (!strncmp(buffer, "KICK ", 5)) // command KICK [no args]
          {
            ...
            if (isUserAuth(user[i] -> nick, user[i] -> pw)) // verifies if user is auth
            {
              ...
              {
                strcpy(msg_aux, "RPLY 602 – Erro. Ação não autorizada, utilizador cliente não é um operador.");
          ...
          else if (!strncmp(buffer, "REGS ", 5)) // command KICK [no args]
          {
            ...
            if (isUserAuth(user[i] -> nick, user[i] -> pw)) // verifies if user is auth
            {
              ...
              {
                strcpy(msg_aux, "RPLY 702 – Erro. Ação não autorizada, utilizador cliente não é um operador.");
          ...
          else if (!strncmp(buffer, "OPER ", 5)) // command KICK [no args]
          {
            ...
            if (isUserAuth(user[i] -> nick, user[i] -> pw)) // verifies if user is auth
            {
              ...
              {
                strcpy(msg_aux, "RPLY 802 – Erro. Ação não autorizada, utilizador cliente não é um operador.");
            ...
            {
              strcpy(msg_aux, "RPLY 803 – Erro. Ação não autorizada, utilizador cliente não está autenticado.");
          ...
          else if (!strncmp(buffer, "QUIT", 4)) // command KICK [no args]
          {
            ...
            if (isUserAuth(user[i] -> nick, user[i] -> pw)) // verifies if user is auth
            {
              ...
              {
                strcpy(msg_aux, "RPLY 902 – Erro. Ação não autorizada, utilizador cliente não é um operador.");
