...
class SaveCommand extends TurtleCommand {

    private Stack<TurtleState> turtleStack;

    public SaveCommand(Turtle owner, Stack<TurtleState> turtleStack){
        this.owner = owner;
    ...
    void execute() {
        ...
        double x = owner.getCurrentXPosition();
        double y = owner.getCurrentYPosition();
        double angle = owner.getCurrentOrientation();
        System.out.println("X: " + x + " | Y: " + y + " | Angle: " + angle);
        turtleStack.add(new TurtleState(x, y, angle));
    }
}

class RestoreCommand extends TurtleCommand {

    private Stack<TurtleState> turtleStack;

    public RestoreCommand(Turtle owner, Stack<TurtleState> turtleStack){
        this.owner = owner;
        this.turtleStack = turtleStack;
    }
    ...
    void execute() {
        ...
        System.out.println("X: " + turtleState.getX() + " | Y: " + turtleState.getY() + " | Angle: " + turtleState.getAngle());
        owner.changePosition(new Position(turtleState.getX(), turtleState.getY()));
        owner.changeOrientation(turtleState.getAngle());
    }
}
