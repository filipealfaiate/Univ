...
//-------------------------------------- 
    ...
    public Stack<TurtleState> turtleStack;
...
//--------------------------------------
    ...
    //    Custom Methods:
    //
    //        Position getCurrentXPosition          (            )
    //        Position getCurrentYPosition          (            )
    //
    //--------------------------------------
    ...
    public void save() {
        instructionBuffer.add(new SaveCommand(this, turtleStack));
    }

    public void restore(){
        instructionBuffer.add(new RestoreCommand(this, turtleStack));
    }
